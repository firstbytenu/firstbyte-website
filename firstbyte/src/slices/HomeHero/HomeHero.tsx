          ...
          <div className="grid grid-rows-2 md:grid-cols-2 h-screen">
            <div className="text-[#546c54] text-center flex items-center justify-center">
              <div className="grid grid-rows-4 md:grid-rows-3 mt-64">
                <div className="text-3xl font-bold text-gray-400 hover:tex-gray-300 md:text-3xl lg:text-6xl">
                  {"Welcome to "}
                ...
                <div className="font-light text-md text-center items-center justify-center lg:my-5">
                  {constants.heroText}
                </div>
              </div>
            </div>
            <motion.div
              ...
              <div className="grid grid-rows-2">
                ...
                <div className="font-md text-md text-center items-center justify-center lg:my-5">
