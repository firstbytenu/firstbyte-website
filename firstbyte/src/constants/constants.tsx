...
export default {
  ...
  team: [
    ...
    },
    {
      name: "Andy Ge",
      whyFirstByte:
        "The mission to promote diversity and equity in CS was something that resonated with me, and with having being involved in many similar activities in high school, it seemed like a good fit for me when I was looking for clubs to join.",
